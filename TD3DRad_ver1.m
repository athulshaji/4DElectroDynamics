%% ----------------------------------------------------------------------
%   Program: FDTD3DRad.m, VERSION 1
%   Author:  Athul Shaji, Project Associate, ECE, IISc Bangalore
...
%   [5] https://empossible.net/academics/emp5304/
...
CN_FDTD = SOLVER(2); S = 0.99; % structured grid
FETD = SOLVER(3); % unstructured grid
...
global sim_domain_materials;global freq;
...
global ISSPLIT INCLUDEMETAL ISSHORT ISCAP ISDIODE a;
ISSHORT=0;
ISSPLIT=1;
ISCAP = 0;
ISDIODE = 0;
INCLUDEMETAL=0; % short included
if(ISDIODE)
    V_diode = load('V_diode_SMS7630.mat');
    I_diode = load('I_diode_SMS7630.mat');
    [a,b] = createFit(I_diode.I_diode, V_diode.V_diode);
end
PECXTOP = [32:34];
PECXBOTTOM = [21:53]; %[21:53];
if(~ISSPLIT)
PECYTOP=[21:85];
end
if(ISSPLIT)
...
PECYBOTTOM = [21:85]; % [21:85];
PECZTOP = 23;
PECZBOTTOM = [21]; % 21;

port = [];
port.one.x = 33; port.one.y = 22; port.one.z = 22;
port.two.x = 33; port.two.y = 85; port.two.z = 22;
eps_z(21:53,21:85,21:23)=4.4;
eps_x(21:53,21:85,21:23)=4.4;
eps_y(21:53,21:85,21:23)=4.4;
% 
if(ISSPLIT && INCLUDEMETAL)
METALXTOP=[32:34];METALYTOP=[53];METALZTOP=23;
sigma_z(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_z(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_z(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_y(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_y(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_y(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_x(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_x(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
sigma_x(METALXTOP,METALYTOP,METALZTOP) = 5.8e7;
eps_x(METALXTOP,METALYTOP,METALZTOP) = 1;
eps_y(METALXTOP,METALYTOP,METALZTOP) = 1;
eps_z(METALXTOP,METALYTOP,METALZTOP) = 1;
end

% top plane: microstrip line
sigma_z(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_z(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_z(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_y(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_y(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_y(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_x(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_x(PECXTOP,PECYTOP,PECZTOP) = 1e200;
sigma_x(PECXTOP,PECYTOP,PECZTOP) = 1e200;
eps_x(PECXTOP,PECYTOP,PECZTOP) = 1;
eps_y(PECXTOP,PECYTOP,PECZTOP) = 1;
eps_z(PECXTOP,PECYTOP,PECZTOP) = 1;

% ground plane: bottom layer
sigma_z(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_z(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_z(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_y(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_y(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_y(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_x(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_x(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
sigma_x(PECXBOTTOM,PECYBOTTOM,PECZBOTTOM) = 1e200;
eps_x(PECXTOP,PECYTOP,PECZTOP) = 1;
eps_y(PECXTOP,PECYTOP,PECZTOP) = 1;
...
if(CN_FDTD)
    CN_FDTD_Solver( T, ...
        ...
        CEx_past, CEy_past, CEz_past, sigma_x);
end
...
%     portz=42;
    ...
    [  tdjyxp, tdjzxp, tdmyxp, tdmzxp,...
        ...
        delx, dely, delz,eps_x,eps_y,eps_z,sigma_x,sigma_y,sigma_z);
    toc;
